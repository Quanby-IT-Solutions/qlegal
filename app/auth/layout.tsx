...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
	...
	const isLegalPage = pathname === "/auth/privacy-policy" || pathname === "/auth/terms-of-service"
	...
	return (
		<div className="relative min-h-screen w-full overflow-hidden">
			...
			<div
				className={`relative z-10 flex min-h-screen p-4 ${
					isLegalPage ? "items-start justify-center pt-8" : "items-center justify-center"
				}`}
			>
				{children}
			</div>
