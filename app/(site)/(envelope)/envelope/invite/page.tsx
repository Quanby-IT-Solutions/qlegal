...
export default function EnvelopeInvitePage() {
  ...
  // First, try to get envelope by token to see if this is an envelope-level invite
  ...
  const acceptWithPlaceholder =
    trpc.envelopeLite.acceptInviteByTokenWithPlaceholder.useMutation({
      onSuccess: async () => {
        setHasRequestedAccess(true)
        // Refetch the invite data to get updated recipient status
        await refetch()
  ...
  const currentUserRecipient = invite?.recipient?.find(
  ...
  const shouldShowApproved =
    !isLoading &&
    currentUserRecipient &&
    currentUserRecipient.status === "APPROVED"
  const shouldShowRejected =
    !isLoading &&
    currentUserRecipient &&
    currentUserRecipient.status === "REJECTED"
            ...
            <div className="relative p-8">
              ...
              >
                ...
                <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
                  Review the details below and request access to proceed with
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      You&apos;ll need to position your signature fields on the
                ...
                <div className="mt-4 flex items-center rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-900/20">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    This is a secure digital signature request. Your signature
              ...
              {shouldShowWaitingForApproval ? (
                ...
                >
                  ...
                  <p className="mb-6 text-gray-600 dark:text-gray-400">
                    Please wait until the host approves your request. You will
                    be notified once your access is granted.
                  </p>
                ...
                >
                  {true ? (
                    <>
                      ...
                      <p className="mb-6 text-gray-600 dark:text-gray-400">
                        Your request has been approved and signature fields are
                        ready. Click the button below to proceed to the signing
                        page.
                      </p>
                      <Button
                        onClick={() => {
                          ...
                          const targetDocumentId =
                            currentUserRecipient?.documentId ??
                            documentId ??
                            firstDocument?.id
                    ...
                    <>
                      ...
                      <p className="mb-6 text-gray-600 dark:text-gray-400">
                        Your request has been approved! You can now proceed to
                        the signing page. The host may still be setting up
                        signature fields.
                      </p>
                      <Button
                        onClick={() => {
                ...
                >
                  ...
                  <p className="mb-6 text-gray-600 dark:text-gray-400">
                    Your request to access this document has been declined by
                    the host.
                  </p>
                  <Button
              ...
              >
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  By requesting access, you agree to sign this document
                  electronically once approved
                </p>
              </motion.div>
            </div>
          </div>
