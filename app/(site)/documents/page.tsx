													...
													<Table className="w-full">
														<TableHeader>
															<TableRow>
																...
																<TableHead className="min-w-25 sm:min-w-27.5">
																	Date & Time
																</TableHead>
																<TableHead className="min-w-30 sm:min-w-35">Document</TableHead>
																<TableHead className="min-w-30 sm:min-w-35">Notary</TableHead>
																...
																return (
																	<Fragment key={doc.id}>
																		<TableRow className={isExpanded ? "border-b-0" : undefined}>
																			...
																			<TableCell className="max-w-35 min-w-0 align-top sm:max-w-50">
