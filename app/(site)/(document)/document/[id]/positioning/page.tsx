...
// type DocumentWithFields = RouterOutputs["signatureLite"]["prepositioning"]["getDocumentWithFields"]
// type EnvelopeWithRecipients = RouterOutputs["signatureLite"]["prepositioning"]["getEnvelopeWithRecipients"]
// type EnvelopeRecipient = NonNullable<EnvelopeWithRecipients>["recipient"][number]
// type DocumentFieldType = NonNullable<DocumentWithFields>["documentFields"][number]
...
// 	const documentQueryResult = trpc.signatureLite.prepositioning.getDocumentWithFields.useQuery(
// 		{ documentId },
// 		{
// 			enabled: !!documentId,
// 			retry: 1,
// 		}
// 	)
// 	// Type-safe extraction: TRPC query data is properly typed via RouterOutputs
// 	// The data property may be inferred as any due to Drizzle query result typing,
// 	// but we assert the correct type from RouterOutputs which matches the actual return type
// 	const document = (documentQueryResult.data ?? undefined)
// 	const documentLoading = documentQueryResult.isLoading
// 	const documentError = documentQueryResult.error

// 	const envelopeQueryResult = trpc.signatureLite.prepositioning.getEnvelopeWithRecipients.useQuery(
...
// 		}
// 	)
// 	// Type-safe extraction: Same as above - asserting correct type from RouterOutputs
// 	const envelope = (envelopeQueryResult.data ?? undefined)
// 	const envelopeLoading = envelopeQueryResult.isLoading
// 	const envelopeError = envelopeQueryResult.error
...
// 			router.push(`/envelope/${envelopeId}` as Route)
// 		} catch (error) {
...
// 		envelope?.recipient?.map((recipient: EnvelopeRecipient, index: number) => ({
// 			id: recipient.id,
...
// 			return []
// 		}
// 		// Type-safe mapping: documentFields is properly typed from RouterOutputs
// 		const fields = document.documentFields
// 		return fields.map((field: DocumentFieldType) => ({
// 			id: field.id,
