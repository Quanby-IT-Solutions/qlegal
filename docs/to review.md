...
| `SUPREME_COURT_COGNITO_URL` | ✅ Set | `"https://cognito-idp.ap-southeast-1.amazonaws.com/..."` |
...
interface Metadata {
  ...
  notarialActType: "Acknowledgment" | "Affirmation" | "Jurat" | "Signature Witnessing" | "Copy Certification"  // ✅ Matches PDF
