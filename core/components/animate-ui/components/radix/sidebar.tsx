...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@/core/components/animate-ui/components/radix/sheet"
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				// Increases the hit area of the button on mobile.
				"text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground z-1 outline-hidden absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				"after:absolute after:-inset-2 md:after:hidden",
