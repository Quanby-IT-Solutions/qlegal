...
export function SessionTypeSelector({ value, onChange, disabled = false, showHeading = true }: SessionTypeSelectorProps) {
	return (
				...
				<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
					...
					>
						...
						<CardContent className="space-y-2">
							<CardDescription>
								Ask questions and get guidance from a notary
							</CardDescription>
