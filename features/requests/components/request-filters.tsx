	...
	return (
		<Card className="mb-6">
			<CardContent className="pt-6">
				<div className={`grid grid-cols-1 gap-4 ${showWorkflowFilter ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
					{/* Search */}
					...
					>
						...
						<SelectContent>
							...
							<SelectItem value="CONFIRMED">
								Confirmed
								<Badge variant="secondary" className="ml-2">{stats.confirmed}</Badge>
							</SelectItem>
					...
					{showWorkflowFilter && (
						<Select 
							...
							onValueChange={(value) => onFiltersChange({ workflow: value as RequestFilters["workflow"] })}
						>
							<SelectTrigger>
