...
export const createEnpEventSchema = z.object({
	...
	startTime: z.string().regex(/^([01]?[0-9]|1[0-9]):[0-5][0-9]$/, "Invalid time format, use HH:MM").optional(),
	endTime: z.string().regex(/^([01]?[0-9]|1[0-9]):[0-5][0-9]$/, "Invalid time format, use HH:MM").optional(),
