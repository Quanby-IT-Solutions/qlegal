...
import { EventItem } from "@/features/appointments/components/schedule/event-item"
import {
	DefaultStartHour,
	EventGap,
	EventHeight,
} from "@/features/appointments/lib/schedule-constants"
...
import {
	...
	sortEvents,
} from "@/features/appointments/lib/schedule-utils"
								...
								>
									<DroppableCell
										...
										onClick={() => {
											...
											startTime.setHours(DefaultStartHour as number, 0, 0)
