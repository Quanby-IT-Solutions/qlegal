...
import { UserFilters } from "../../user-management/components/user-filters"
import { UserList } from "../../user-management/components/user-list"
import { UserStats } from "../../user-management/components/user-stats"
			...
			<div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-6">
				<div>
					...
					<p className="text-sm text-gray-600 sm:text-base dark:text-gray-400">
						Manage platform All Roles, and Permissions
					</p>
				</div>
