...
// 		const { defaultSignature, isLoading: isLoadingDefaultSignature } = useUserDefaultSignature()
...
// 		const [activeTab, setActiveTab] = useState<"draw" | "type" | "upload" | "default">(
// 			finalDefaultSignature ? "default" : "draw"
// 		) // Start with default tab if available
...
// 				hasData =
// 					useDefaultInDefaultTab && finalDefaultSignature !== null && finalDefaultSignature !== ""
...
// 				console.log("useEffect: Default signature activated, running validation")
// 				checkHasSignature()
// 			}
...
// 								<canvas
// 									ref={canvasRef}
// 									className="bg-background block w-full cursor-crosshair dark:bg-gray-100"
...
// 										Preview:
// 									</Label>
// 									<p className="text-foreground py-4 text-center font-serif text-2xl font-semibold">
// 										{signatureText}
// 									</p>
// 								</div>
// 							)}
...
// 									Accepted formats: PNG, JPG, GIF. Images will be scaled automatically.
// 								</p>
// 							</div>
// 							{uploadedImage && (
...
// 										<div
// 											className="bg-background rounded border p-2 shadow-sm dark:bg-gray-100"
...
// 													if (onSignatureChangeRef.current) {
// 														console.log("Immediately calling onSignatureChangeRef with true")
// 														onSignatureChangeRef.current(true)
// 													}
// 												}
// 											}}
...
// 									<p className="mb-1 text-sm font-medium">Loading default signature...</p>
// 								</div>
// 							) : (
// 								<div className="text-muted-foreground py-8 text-center">
// 									<User className="text-muted-foreground/40 mx-auto mb-3 h-12 w-12" />
// 									<p className="mb-1 text-sm font-medium">No default signature</p>
// 									<p className="text-xs">
