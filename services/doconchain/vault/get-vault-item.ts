...
async function fetchVaultItem(params: { token: string; uuid: string }): Promise<DoconchainVaultItemResponse> {
	...
	return (text ? (JSON.parse(text) as DoconchainVaultItemResponse) : {}) as DoconchainVaultItemResponse
}
