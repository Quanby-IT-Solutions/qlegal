...
export const TwoFactorEmail = ({ user, code, type }: TwoFactorEmailProps) => (
	<Html>
		...
		<Body style={main}>
			<Preview>
				Your verification code is {code} - Use this code to {getActionText(type)}
			</Preview>
			<Container style={container}>
				...
				<Section style={box}>
					...
					<Text style={paragraph}>
						We received a request to {getActionText(type)} for your Quanby Sign account.
						{type === "disable"
					...
					{type !== "disable" && (
						<Section style={codeContainer}>
							...
							<Text style={codeExpiry}>This code will expire in 10 minutes</Text>
						</Section>
					)}
					...
					{type === "disable" && (
						<Section style={disabledContainer}>
							<Text style={disabledText}>✅ Two-factor authentication has been disabled</Text>
							<Text style={disabledSubtext}>
								Your account security has been reduced. We recommend re-enabling 2FA for better
								protection.
							</Text>
						</Section>
					)}
					...
					<Section style={tipsContainer}>
						<Text style={tipItem}>• Never share your verification codes with anyone</Text>
						<Text style={tipItem}>
					...
					<Text style={paragraph}>
						If you need help or have questions about your account security, please contact our
						support team.
					</Text>

					<Button style={button} href={`${getUrl()}/profile/security`}>
				...
				<Section style={footer}>
					<Text style={footerText}>
						This is an automated security message from Quanby Sign. Please do not reply to this
						email. If you didn&apos;t request this verification, please contact support immediately.
					</Text>
				</Section>
			</Container>
		</Body>
