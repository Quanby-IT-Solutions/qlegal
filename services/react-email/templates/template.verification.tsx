				...
				<Body className="mx-auto my-auto bg-gray-100 p-4 font-sans text-gray-800">
					...
					>
						...
						>
							...
							<Text className="m-0 mt-1 text-sm text-pink-100">Confirm your account</Text>
						</Section>
						...
						<Section className="px-8 py-10">
							...
							<Text className="mb-6 text-sm leading-relaxed text-gray-700">
								Thank you for signing up! We want to make sure it's really you. Please confirm your
							...
							<Text className="mb-6 text-sm leading-relaxed text-gray-700">
								This verification link will expire in <strong>24 hours</strong> for security
								reasons.
							</Text>
