...
export const PasswordResetTemplate = ({ email, resetLink }: PasswordResetTemplateProps) => (
	<Html>
		<Head />
			...
			<Body className="mx-auto my-auto bg-gray-50 p-6 font-sans text-gray-800">
				...
				>
					...
					<Section className="px-10 pb-10">
						...
						<Text className="mb-6 text-base leading-relaxed text-gray-700">
							We received a request to reset your password for your QSign account. If this was you,
