...
ARG SUPREME_COURT_API_URL
ARG SUPREME_COURT_AUTH_URL
...
ENV DOCONCHAIN_APP_URL=${DOCONCHAIN_APP_URL}
...
ENV DOCONCHAIN_ORG_INVITE_CODE=${DOCONCHAIN_ORG_INVITE_CODE}
ENV DOCONCHAIN_ORGANIZATION_UUID=${DOCONCHAIN_ORGANIZATION_UUID}
...
# Supreme Court eNotarization API
ENV SUPREME_COURT_API_URL=${SUPREME_COURT_API_URL}
ENV SUPREME_COURT_AUTH_URL=${SUPREME_COURT_AUTH_URL}
